...
const StyledInput = CrxComponent(styled.input`
  position: relative;
  padding: 7.5px 20px;
...
const CrxInput = ({ placeholder, width, onChange, name, value, err, helperText, type, style, bg, color, placecolor, className }) => {
  return (
